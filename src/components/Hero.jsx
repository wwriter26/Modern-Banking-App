...
const Hero = () =>(
  <section id="home" className={`flex md:flex-row flex-col  ${styles.paddingY}`}>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}> 
      ...
      {/* adding a z-index to make the image show above the gradients */}

      {/* adding the gradients to image */}
      <div className="absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient"/>
      <div className="absolute z-[1] w-[80%] h-[80%] rounded-full bottom-40 white__gradient"/>
      <div className="absolute z-[0] w-[50%] h-[50%] bottom-20 blue__gradient"/>
    </div>
{/* creating a get started div for mobile devices that appears at the bottom of the page rather than the side. */}
